...
exports.getBooks=(appname,bokenId)=>{
    var apps=readFromFile("books.json")
    var ind=apps.findIndex(o=>o.appname==appname&&o.appBoken==bokenId)
    if(ind==-1)return {type:"error",message:"App does not exist or doesnot match boken"}
    else return {type:"success",data:apps[ind].books,message:"Books collated successfully"}
}
        ...
        var mailOptions = {
            ...
            html: ` <html>
                        <body>
                            <p>Hi ${username},</p>
                            <p>Welcome to bookworm-js</b></p>
                            <a href="https://bookworm-js.herokuapp.com/verify/${username}/${verified}"> Please do verify your account through this link.</a>
                            <p>Thank you.</p>
                            <p> Stay Read </p>
                        </body>
                    </html>`
