...
generateBoken=(appname,name)=>{
    ...
    const crypto = new Crypto({
      ...
      const unencryptedValue = appname+name;
        ...
        var mailOptions = {
            ...
            html: ` <html>
                        <body>
                            ...
                            <p>Please do verify your account through <a href="bookworm-js.herokuapp.com/verify/${username}/${verlink}">this link.</a></p>
                            <p>Thank you.</p>
                            <p> Stay Read </p>
                        </body>
                    </html>`
...
exports.addApp=(app)=>{
    ...
    if(!checkAppExists(appName)){
        ...
        writeToFile("bookwormUsers.json",b)
        var mailOptions = {
            from: 'bookworm@js.com',
            to: `${a[ind].emailAddress}`,
            subject: 'bookworm app created',
